    ...
    <div className={styles.container}>
      <motion.div className={styles.left}>
        ...
        <div className={styles.left__actions}>
          <Link className={styles.left__actions-btn} to='/' duration={500}>Search By Profile or Tag</Link>
          <Link className={styles.left__actions-btn} to='/' duration={500}>Search By Select Tweet Post</Link>
        </div>
      </motion.div>
      <motion.div className={styles.left}>
