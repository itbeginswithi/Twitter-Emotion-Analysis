...
const Header = () => {
  return (
    <div className={`${styles.container} f-height`}>
      <motion.div className={styles.left} transition={{duration: 1}} whileInView={{opacity: [0, 1], x: ['-100px', '0px']}}>
        ...
        <div className={styles.left__actions}>
          <Link className={styles.left__actions_btn} to='analyseTweet' duration={500}>Search By Profile or Tag</Link>
          <Link className={styles.left__actions_btn} to='/' duration={500}>Analyse Select Tweet Post</Link>
        </div>
      </motion.div>
