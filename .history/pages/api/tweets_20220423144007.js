...
const URLParams = 'tweet.fields=created_at&expansions=author_id&user.fields=created_at,profile_image_url_bigger'
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const result = await fetch(`${URL}/tweets?ids=1517707521343082496&${URLParams}`, {
      method: 'GET',
      headers: myHeaders
    });
