...
const URLParams = 'tweet.fields=created_at&expansions=author_id&user.fields=created_at,&max_results=25'
...
const getUserTimeline = async (req, res) => {
    ...
    //fetch UserTimeline
    const userTimeline = await(await fetch(`${URL}/users/${userId}/tweets?`))
}
