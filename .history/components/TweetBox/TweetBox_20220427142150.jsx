...
, userImage, username, tweetText
const TweetBox = ({showProfile, tweetAnalysis, createdAt}) => {
  const {fetchingAnalysis, tweet: tweetText, tweetAuthor: {name: username,
    profile_image_url: userImage,
    created_at: createdAt}} = useSelector(state => state.tweetBox);
  const [errors, setErrors] = useState(null);

  useEffect(() => {console.log(fetchingAnalysis)}, [fetchingAnalysis])
