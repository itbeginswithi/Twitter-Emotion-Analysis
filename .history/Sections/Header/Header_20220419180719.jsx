    ...
    <div className={styles.container}>
      ...
      <motion.div className={styles.right}>
        ...
        <div className={styles.right__emotionIcons}>
          <img src={joy} alt="joy" draggable={false} width={65} height={65}/>
          <img src={sadness} alt="sadness" draggable={false} width={65} height={65}/>
          <img src={anger} alt="anger" draggable={false} width={65} height={65}/>
          <img src={disgust} alt="disgust" draggable={false} width={65} height={65}/>
          <img src={fear} alt="fear" draggable={false} width={65} height={65}/>
        </div>
      </motion.div>
    </div>
  )
