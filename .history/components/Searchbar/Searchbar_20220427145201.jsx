...
const Searchbar = ({children, placeholder, description, handleSubmit, searchByStatus, error}) => {
  const errorMessage = useSelector(state => state.tweetBox.error);
