...
const TweetBox = ({showProfile, userImage, username, tweetText, TweetAnalysis, datePosted}) => {
    ...
    <div className={styles.container}>
      ...
      <div className={styles.tweet}>
        <div className={showProfile ? `${styles.tweet__text}` : `${styles.tweet__textModal}`}>
          {TweetText || 'Enim pariatur ea ullamco commodo non commodo ad dolor aliqua magna.
