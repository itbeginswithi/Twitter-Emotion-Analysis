...
const Searchbar = ({children, placeholder, description, handleSubmit, searchByStatus, loading}) => {
  const dispatch = useDispatch();
  const {displayTweetBox: tweetBoxIsVisible} = useSelector(state => state.tweetBox.displayTweetBox);
