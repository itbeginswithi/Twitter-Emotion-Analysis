                ...
                <div className={styles.results}>
                    {
                        ...
                        <div className={styles.kowalskiAnalysis}>
                            <div className={styles.emotionScore}>
                                <img src="/static/assets/happy.png" alt="joy" title="joy"/>
                                <span className={styles.score}>{(results.joy).toFixed(3)}</span>
                            </div>
                            <div className={styles.emotionScore}>
                                <img src="/static/assets/sad.png" alt="sadness" title="sadness"/>
                            ...
                            <div className={styles.emotionScore}>
                                <img src="/static/assets/scared.png" alt="fear" title="fear"/>
                                <span className={styles.score}>{(results.fear).toFixed(3)}</span>
                            </div>
                            <div className={styles.emotionScore}>
                                <img src="/static/assets/angry.png" alt="anger" title="anger"/>
