...
const AnalyseTweet = () => {
  ...
  return (
    <div id="analyseTweet" className={`flex f-height section-padding`}>
        ...
        <Searchbar handleSubmit={handleSubmit} searchByStatus={getStatusId description="Analyse a select tweet" placeholder="https://twitter.com/user/status/151458909249539">
          <TweetBox 
            showProfile 
            tweetText={tweet} 
